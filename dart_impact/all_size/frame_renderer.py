...
def render_single_HSTview_colorgroups(frame):
    ...
    # plot Didymos and Dimorphos
    ax.scatter(p_projected[0, 1], p_projected[0, 2], c='k', s=10, zorder=3, label='Didymos')
    ax.scatter(p_projected[1, 1], p_projected[1, 2], c='blue', s=8, zorder=2, label='Dimorphos')

    # Plot dust particles in groups
    group_characs = {1: ['0.1 mm', '#8B4513'],
                     2: ['1 mm', '#87CEEB'],
                     3: ['1 cm', '#228B22'],
                     4: ['10 cm', '#FF4500']}
    for group, charac in group_characs.items():
